...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferAmount(@RequestBody @Valid Transfer transfer){
	  ...
	  try {
		  ...
		  return new ResponseEntity<>(inSufficientFundsException.getMessage(), HttpStatus.UNPROCESSABLE_ENTITY);
	  }catch(TransferBetweenSameAccountException transferBetweenSameAccountException) {
		  return new ResponseEntity<>(transferBetweenSameAccountException.getMessage(), HttpStatus.BAD_REQUEST);
	  }
